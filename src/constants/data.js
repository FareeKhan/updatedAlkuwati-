...
export const refund_policy_ar = `شكرًا لتسوقك مع ديفا ليدي. نحن نقدر رضاك ونريد أن نضمن أن تكون لديك تجربة إيجابية مع منتجاتنا. إذا لم تكن راضيًا تمامًا عن مشترياتك، نحن هنا للمساعدة.
