...
export const productAddToCart = createSlice({
    ...
    reducers: {
        addProductToCart: (state, action) => {
            ...
            const { productName, price,varID, size,odo_id, counter,Variants,Variants_stock, id, image, subText,productWeight } = action.payload;
            const newProductAddedToCart = { productName,varID ,odo_id,price, size, Variants_stock,Variants,counter, id, image, subText ,productWeight}
